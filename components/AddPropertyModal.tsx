...
import IpcCalculator from './properties/IpcCalculator';
...
const AddPropertyModal: React.FC<AddPropertyModalProps> = ({
  ...
  // Visibilidad de la calculadora IPC (la lógica/estado viven en <IpcCalculator/>).
  ...
  // Aplica el resultado de la calculadora IPC: actualiza alquiler + fecha de inicio
  // y cierra el panel. La lógica de cálculo vive en <IpcCalculator/>.
  const handleApplyIpc = (newRent: string, newContractStart: string) => {
    setFormData(prev => ({
      ...prev,
      monthlyRent: newRent,
            ...
            <div className="space-y-3">
              ...
              {showIpc && (
                <IpcCalculator
                  ...
                  adjustmentMonths={formData.adjustmentMonths}
                  contractStart={formData.contractStart}
                  onApply={handleApplyIpc}
                />
              )}
            </div>
          )}
