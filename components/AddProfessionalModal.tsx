...
const AddProfessionalModal: React.FC<AddProfessionalModalProps> = ({ onClose, onSave }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newPro: Professional = {
      ...
      rating: 5.0, // New pros start with 5 stars or 0
      speedRating: 5.0
    };
    ...
    <div className="fixed inset-0 z-[1300] bg-black/50 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="bg-blue-50 p-6 border-b border-blue-100 flex justify-between items-center">
          <div>
            <h2 className="text-xl font-bold text-blue-900">Nuevo Profesional</h2>
            <p className="text-sm text-blue-600 mt-1">Agregar a la agenda de confianza</p>
          </div>
