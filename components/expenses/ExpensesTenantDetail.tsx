...
const ExpensesTenantDetail: React.FC<ExpensesTenantDetailProps> = ({
    ...
    const { loadExpenseSheetData, setTenants, setProperties } = useDataContext();

    // ── Editar perfil del inquilino (nombre + departamento) ────────────────────
    ...
    const openEditProfile = () => {
        ...
        setEditUnit(property?.unitLabel ?? '');
    ...
    const handleSaveProfile = async () => {
        ...
        if (!nameChanged && !unitChanged) { setEditingProfile(false); return; }
